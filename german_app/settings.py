"""
Django settings for german_app project.
...
SECRET_KEY = 'django-insecure-k9#$-z8ffi_^z&cqx#c_rb^=7g%j5=cp&v(7^j1-&aafduav)1'
...
WSGI_APPLICATION = 'german_app.wsgi.application'
